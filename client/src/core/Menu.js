...
const Menu = withRouter(({history}) => (
  <AppBar position="static">
    <Toolbar>
      ...
      <div>
        ...
        </Link>
        {
          auth.isAuthenticated() && (<span>
            <Link to={"/expenses/all"} style ={{textDecoration:"none"}}>
              <Button style={isActive(history, "/expenses/all"  )} >Expenses</Button>
            </Link>
            <Link to={"/expenses/reports"} style ={{textDecoration:"none"}}>
      ...
      {
        auth.isAuthenticated() && (<span>
          <Link to="/expenses/new" style ={{textDecoration:"none"}}><Button style={isButtonActive(history, "/expenses/new")}><AddIcon style={{marginRight: 4}}/> Add Expense</Button></Link>  
